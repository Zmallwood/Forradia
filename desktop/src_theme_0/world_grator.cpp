                ...
                if (dx * dx + dy * dy <= r * r)
                {
                    ...
                    if (tl)
                    {
                        ...
                        if (elev_n == 0 && elev_e == 0 && elev_s == 0 &&
                            elev_w == 0 && elev_nw == 0 && elev_ne == 0 &&
                            elev_se == 0 && elev_sw == 0 && elev_nn == 0 &&
                            elev_ww == 0 && elev_ee == 0 && elev_ss == 0 &&
                            elev_nwnw == 0 && elev_nene == 0 &&
                            elev_sese == 0 && elev_swsw == 0)
                        {
                ...
                for (auto x = x_cent - r; x <= x_cent + r; x++)
                {
                    ...
                    if (dx * dx + dy * dy <= r * r)
                    {
                        ...
                        if (tl && tl->ground() != hash("ground_water"))
                        {
                            ...
                            if ((tl_n &&
                                 tl_n->ground() == hash("ground_water")) ||
                                (tl_s &&
                                 tl_s->ground() == hash("ground_water")) ||
                                (tl_w &&
                                 tl_w->ground() == hash("ground_water")) ||
                                (tl_e &&
                                 tl_e->ground() == hash("ground_water")) ||
                                (tl_nw &&
                                 tl_nw->ground() == hash("ground_water")) ||
                                (tl_ne &&
                                 tl_ne->ground() == hash("ground_water")) ||
                                (tl_sw &&
                                 tl_sw->ground() == hash("ground_water")) ||
                                (tl_se &&
                                 tl_se->ground() == hash("ground_water")))
                            {
                                continue;
                            }
