...
namespace Scripting
{
    ...
    PYBIND11_EMBEDDED_MODULE(embedded, m)
    {
        ...
        py::class_<engine::Renderers::img_2d_rend>(m, "img_2d_rend")
            .def("draw_img",
                 [](engine::Renderers::img_2d_rend &self, str_view image_name,
        ...
        m.def(
            ...
            py::return_value_policy::reference);
        m.def(
            "get_world_grator", []() -> Theme0::WorldGeneration::world_grator &
            { return _<Theme0::WorldGeneration::world_grator>(); }, py::return_value_policy::reference);
        m.def(
            "get_tl_hovering", []() -> tl_hovering &
            { return _<tl_hovering>(); }, py::return_value_policy::reference);
        m.def(
