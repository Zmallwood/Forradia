...
namespace Core
{
        ...
        aiMesh *mesh, const aiScene *scene)
    {
        ...
        //      // material->Get(AI_MATKEY_TEXTURE(aiTextureType_DIFFUSE, 0),
        //      path); std::cout << "NUM TEXES: " << scene->mNumTextures <<
        //      std::endl; if ('*' == path.data[0]) {
        ...
        //      scene->mMaterials[0]->GetTexture(aiTextureType_DIFFUSE, 0,
        //      &path); std::cout << path.C_Str() << std::endl;
        //    }
        return textures;
    }
