...
void GUIComponentsLibrary::gui_label::render_derived() const
{
    ...
    _<engine::Renderers::text_rend>().draw_str(text_, b.x, b.y, engine::Renderers::font_szs::_20, cent_align_,
                            color_);
}
...
void GUIComponentsLibrary::gui_button::render_derived() const
{
    ...
    auto b{bounds()};
    _<engine::Renderers::text_rend>().draw_str(text_, b.x + b.w / 2, b.y + b.h / 2, engine::Renderers::font_szs::_20,
                            true);
}
...
void GUIComponentsLibrary::gui_win::gui_win_title_bar::render_derived() const
{
    gui_panel::render_derived();
    auto parent_win_b{parent_win_.bounds()};
    _<engine::Renderers::text_rend>().draw_str(k_win_title, parent_win_b.x + 0.01f,
                            parent_win_b.y + 0.01f, engine::Renderers::font_szs::_20, false,
                            colors::yellow);
}
...
void GUIComponentsLibrary::gui_chat_box::render_derived() const
{
    ...
    _<engine::Renderers::img_2d_rend>().draw_img("black", sep_rect.x, sep_rect.y, sep_rect.w,
                              sep_rect.h);
}
