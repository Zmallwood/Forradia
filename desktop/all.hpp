 ...
 */
#define _NS_START_ namespace forr { namespace gui_test {}
#define _NS_END_ }
...
class model {
 ...
 private:
  ...
  void process_node(aiNode *node, const aiScene *scene, aiMatrix4x4 transform);

  mesh process_mesh(aiMesh *mesh, const aiScene *scene,
                    aiMatrix4x4 transformation);

  vec<vertex> get_vertices(aiMesh *mesh, glm::vec3 &extents, glm::vec3 &origin,
                           aiMatrix4x4 transformation);
