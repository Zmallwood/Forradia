        ...
        namespace WorldStructure
        {
            ...
            class NPC
            {
              public:
                ...
                void
                SetTicksNextSpontaneousSpeech(int value)
                {
            ...
            class ObjectsStack
            {
              public:
                ...
                void
                AddTreeObject(StringView objectTypeName);

                void RemoveObjectOfType(
            ...
            class Tile
            {
              public:
                ...
                void SetCreature(
                    SharedPtr<Forradia::Theme0::
                                  WorldStructure::Creature>
                        val)
                {
                    m_creature = val;
                }
                ...
                void
                SetNPC(SharedPtr<Forradia::Theme0::
                                     WorldStructure::NPC>
                           value)
                {
                    m_npc = value;
              ...
              private:
                ...
                int m_ground{0};
                SharedPtr<Forradia::Theme0::WorldStructure::
                              ObjectsStack>
                    m_objectsStack;
                SharedPtr<Forradia::Theme0::WorldStructure::
                              Creature>
                    m_creature;
                SharedPtr<
                    Forradia::Theme0::WorldStructure::NPC>
                    m_npc;
                int m_elevation{0};
                int m_waterDepth{0};
                Directions m_riverDirection1{
                    Directions::None};
