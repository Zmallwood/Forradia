        ...
        namespace WorldStructure
        {
            ...
            class Tile
            {
              public:
                ...
                void SetCreature(
                    SharedPtr<Forradia::Theme0::WorldStructure::Creature> val)
                {
                    m_creature = val;
                }
                ...
                void
                SetNPC(SharedPtr<Forradia::Theme0::WorldStructure::NPC> value)
                {
                    m_npc = value;
                }
              ...
              private:
                ...
                SharedPtr<Forradia::Theme0::WorldStructure::ObjectsStack>
                    m_objectsStack;
                SharedPtr<Forradia::Theme0::WorldStructure::Creature>
                    m_creature;
