    ...
    namespace Theme0
    {
        namespace WorldStructure
        {
            ...
            void NPC::GenerateName()
            {
                ...
                char c0{
                    vowels.at(GetRandomInt(vowels.size()))};
            ...
            void Tile::Initialize()
            {
                m_objectsStack = std::make_shared<
                    Forradia::Theme0::WorldStructure::
                        ObjectsStack>();
            }
            ...
            bool
            WorldArea::IsValidCoordinate(Point coord) const
            {
