                  ...
                  public:
                    class ImageBank
                    {
                      public:
                        ...
                        GLuint
                        GetTexture(int imageNameHash) const;

                        Size GetImageSize(
                            int imageNameHash) const;

                        bool TextTextureExists(
                            float x, float y,
                            int uniqueID) const;
                  ...
                  public:
                    class ModelBank
                    {
                      ...
                      private:
                        ...
                        SharedPtr<Model> LoadSingleModel(
                            StringView filePath);
              ...
              public:
                class IScene
                {
                  public:
                    ...
                    void SetInitializeDerived(
                        Function<void()> value)
                    {
                        m_initializeDerived = value;
                    }

                    void SetOnEnterDerived(
                        Function<void()> value)
                    {
              ...
              public:
                class KeyboardInput
                {
                  public:
                    ...
                    void
                    RegisterKeyRelease(SDL_Keycode key);

                    bool
                    KeyIsPressed(SDL_Keycode key) const;
                ...
                class MouseInput
                {
                  public:
                    ...
                    void
                    RegisterMouseButtonDown(Uint8 button);

                    void
                    RegisterMouseButtonUp(Uint8 button);
