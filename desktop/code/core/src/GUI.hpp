...
namespace Forradia
{
    namespace GUIComponentsLibrary
    {
        ...
        {
          public:
            GUIPanel(float x, float y, float width,
                     float height,
          ...
          private:
            inline static const String
                k_defaultBackgroundImage{"gui_panel_bg"};
        ...
        {
          public:
            GUIButton(float x, float y, float width,
                      float height, StringView text,
        ...
        {
          public:
            GUIMovablePanel(float x, float y, float width,
                            float height)
                : GUIPanel(x, y, width, height)
            {
            }
        ...
        class GUIFPSPanel : public GUIMovablePanel
        {
          public:
            GUIFPSPanel()
                : GUIMovablePanel(0.92f, 0.02f, 0.07f,
                                  0.04f)
            {
                Initialize();
            }
