...
namespace Forradia
{
    ...
    void GUIComponentsLibrary::GUIMovablePanel::UpdateDerived()
    {
        ...
        if (GetIsBeingMoved())
        {
            auto currentMousePosition{GetNormallizedMousePosition(
    ...
    void GUIComponentsLibrary::GUIWindow::GUIWindowTitleBar::Initialize()
    {
        ...
        AddChildComponent(std::make_shared<GUIButton>(
            parentWindowBounds.width -
                ConvertWidthToHeight(0.015f,
                                     _<Engine::SDLDevice>().GetWindow()),
            0.01f, 0.015f,
            ConvertWidthToHeight(0.015f, _<Engine::SDLDevice>().GetWindow()),
            "X", [this] { m_parentWindow.ToggleVisibility(); }));
    }

    void
    GUIComponentsLibrary::GUIWindow::GUIWindowTitleBar::RenderDerived() const
    {
        GUIPanel::RenderDerived();
        ...
        _<Engine::Renderers::TextRenderer>().DrawString(
            ...
            parentWindowBounds.y + 0.01f, Engine::Renderers::FontSizes::_20,
            false, Colors::Yellow);
    }
    ...
    void GUIComponentsLibrary::GUIChatBox::RenderDerived() const
    {
        ...
        auto separatorRect{RectF{bounds.x,
