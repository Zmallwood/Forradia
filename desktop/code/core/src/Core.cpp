...
namespace Forradia
{
    namespace Core
    {
        ...
        void Engine::Run()
        {
            ...
            catch (std::exception &e)
            {
                SDL_ShowSimpleMessageBox(
                    SDL_MESSAGEBOX_ERROR, "Error", e.what(),
                    nullptr);
            }
        }
        ...
        SharedPtr<SDL_Window>
        Engine::SDLDevice::CreateWindow()
        {
        ...
        void Engine::Cursor::Render()
        {
            ...
            _<Renderers::Image2DRenderer>().DrawImage(
                ...
                mousePosition.y - height / 2, width,
                height);
        }
        ...
        GLuint
        Engine::Assets::Images::ImageBank::GetTexture(
        ...
        Size
        Engine::Assets::Images::ImageBank::GetImageSize(
            int imageNameHash) const
        {
        ...
        GLuint Engine::Assets::Images::ImageBank::
            LoadSingleTexture(
        ...
        bool Engine::Assets::Images::ImageBank::
            TextTextureExists(float x, float y,
                              int textHash) const
        {
        ...
        GLuint Engine::Assets::Images::ImageBank::
            ObtainTextTexture(float x, float y,
                              int textHash)
        {
            if (TextTextureExists(x, y, textHash))
            {
                return m_textTextures.at(x).at(y).at(
                    textHash);
            }
        ...
        void Engine::Assets::Models::ModelBank::Model::
                        ...
                        aiMatrix4x4 transformation)
        {
                 ...
                 i++)
            {
                ...
                m_meshes.push_back(ProcessMesh(
                    mesh, scene, transformation));
            }
        ...
        Engine::Assets::Models::ModelBank::Model::
                        ...
                        aiMatrix4x4 transformation)
        {
            ...
            Vector<Texture> textures{
                GetTextures(mesh, scene)};

            return Engine::Assets::Models::ModelBank::Mesh(
                vertices, indices, textures, extents,
                origin, mesh->mName);
        }

        Vector<Engine::Assets::Models::ModelBank::Vertex>
        Engine::Assets::Models::ModelBank::Model::
            GetVertices(aiMesh *mesh, glm::vec3 &extents,
                        glm::vec3 &origin,
                        aiMatrix4x4 transformation)
        {
        ...
        Vector<unsigned int> Engine::Assets::Models::
            ...
            GetTextures(aiMesh *mesh, const aiScene *scene)
        {
            ...
            scene->mMaterials[mesh->mMaterialIndex]
                ->GetTexture(aiTextureType_DIFFUSE, 0, &s);
        ...
        {
            auto modelResult{
                std::make_shared<Model>(filePath)};
        ...
        void Engine::ScenesCore::SceneManager::
            UpdateCurrentScene()
        {
            if (m_scenes.contains(m_currentScene))
            {
        ...
        void
        Engine::Input::KeyboardInput::RegisterKeyRelease(
            SDL_Keycode key)
        {
            m_pressed.erase(key);
        }
        ...
        void
        Engine::Input::MouseInput::RegisterMouseButtonDown(
            Uint8 button)
        {
            switch (button)
            {
        ...
        void
        Engine::Input::MouseInput::RegisterMouseButtonUp(
            Uint8 button)
        {
            switch (button)
            {
