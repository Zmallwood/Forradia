        ...
        namespace GameplayCore
        {
            void UpdateKeyboardActions()
            {
                if (_<Core::Engine::Input::KeyboardInput>()
                        .KeyIsPressedPickResult(SDLK_ESCAPE))
                {
            ...
            void UpdateKeyboardMovement()
            {
                ...
                if (now >=
                        _<Theme0::GameplayCore::Player::PlayerCharacter>()
                            ...
                            InvertMovementSpeed(_<Theme0::GameplayCore::Player::
                                                      PlayerCharacter>()
                                                    .GetMovementSpeed()) &&
            ...
            void TileHovering::Update()
            {
                ...
                auto canvasSize{
                    GetCanvasSize(_<Engine::SDLDevice>().GetWindow())};
                ...
                for (auto y = -extraRows; y < gridSize.height + extraRows; y++)
                {
                    ...
                    {
                        auto rawXCoordinate{playerPos.x -
                                            (gridSize.width - 1) / 2 + x};
                        auto rawYCoordinate{playerPos.y -
                        ...
                        if (!worldArea->IsValidCoordinate(xCoordinate,
                                                          yCoordinate))
                        {
                            continue;
                        }
                        ...
                        auto success{glm::intersectLineTriangle(
                            c2, dir, v00, v10, v11, result)};

                        if (!success)
                        {
                            success = {glm::intersectLineTriangle(
                                c2, dir, v00, v11, v01, result)};
                        }

                        if (success)
                        {
                            m_hoveredCoordinate = {rawXCoordinate,
                                                   rawYCoordinate};
                        }
                    }
                }
                ...
                // auto topYCoordinate{
                //     CInt(playerPosition.y - (gridSize.height - 1) / 2) -
                //     extraRows};
                ...
                // for (auto y = -extraRows; y < gridSize.height +
                // extraRows; y++)
                // {
                //     auto yCoordinate{
                //         CInt(playerPosition.y - (gridSize.height - 1) / 2
                ...
                //     auto coordinate{Point{hoveredXCoordinate,
                //     yCoordinate}};
                ...
                //         screenRelativeYPx =
                //             0.5f +
                //             (y - (gridSize.height - 1) / 2) *
                //             tileSize.height + playerElevation *
                //             tileSize.height / 2;
                ...
                //     screenRelativeYPx =
                //         0.5f + (y - (gridSize.height - 1) / 2) *
                //         tileSize.height + (playerElevation - elevation) *
                //         tileSize.height / 2;

                //     auto coordinateNW{Point{coordinate.x, coordinate.y}};

                //     auto coordinateNE{Point{coordinate.x + 1,
                //     coordinate.y}};

                //     auto coordinateSW{Point{coordinate.x, coordinate.y +
                //     1}};

                //     auto coordinateSE{Point{coordinate.x + 1,
                //     coordinate.y + 1}};
                ...
                //     {
                //         m_hoveredCoordinate = {hoveredXCoordinate,
                //         yCoordinate};
