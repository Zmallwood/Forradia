    ...
    namespace Theme0
    {
        namespace SpecializedGUI
        {
            ...
            void GUIInventoryWindow::RenderDerived() const
            {
                ...
                auto numColumns{
                    CInt((bounds.width - 2 * marginX) /
                         slotWidth)};

                auto numRows{
                    CInt((bounds.height - 2 * marginY -
                          (yStart - bounds.y)) /
                         slotHeight)};
            ...
            void
            GUIPlayerBodyWindow::SelectBodyPart(int type)
            {
            ...
            void GUIInteractionMenu::BuildMenu()
            {
                ...
                auto objects{
                    tile->GetObjectsStack()->GetObjects()};
