        ...
        namespace Scripting
        {
            ...
            PYBIND11_EMBEDDED_MODULE(embedded, m)
            {
                ...
                py::class_<Core::Engine::ScenesCore::IScene::ScenesGUI::GUIRoot,
                           SharedPtr<Core::Engine::ScenesCore::IScene::
                                         ScenesGUI::GUIRoot>>(m, "GUIRoot")
                    .def("add_child_comp",
                ...
                py::class_<GUIComponentsLibrary::GUILabel,
                    ...
                    .def(py::init<float, float, float, float, StringView, bool,
                         ...
                         py::arg("color") = Colors::WheatTransparent)
                ...
                py::class_<Core::Engine::ScenesCore::IScene>(m, "IScene")
                    ...
                    .def("set_init_derived",
                         [](Core::Engine::ScenesCore::IScene &self,
                            py::function f)
                ...
                py::class_<Core::Engine::ScenesCore::SceneManager>(
                    m, "SceneManager")
                    .def(py::init<>())
                    .def("add_scene",
                ...
                py::class_<Theme0::WorldGeneration::WorldGenerator>(
                    m, "WorldGenerator")
                    .def(py::init<>())
                    .def("gen_new_world", &Theme0::WorldGeneration::
                                              WorldGenerator::GenerateNewWorld);

                py::class_<Core::Engine::Input::KeyboardInput>(m,
                                                               "KeyboardInput")
                ...
                py::class_<Engine::Renderers::Image2DRenderer>(
                    ...
                    .def("draw_img",
                         [](Engine::Renderers::Image2DRenderer &self,
                            int image_name_hash, float x, float y, float w,
                            float h)
                ...
                py::class_<Theme0::GameplayCore::TileHovering>(m,
                                                               "TileHovering")
                ...
                m.def("make_shared_gui_button",
                      ...
                      {
                          return std::make_shared<
                              GUIComponentsLibrary::GUIButton>(x, y, w, h, text,
                                                               action);
                      });
