...
{
    void WorldGenerator::GenerateSingleLake(int minX, int minY, int maxX, int maxY,
                                            int recursion) const
    {
        if (recursion == 0)
        {
                    ...
                    if (dX * dX + dY * dY <= r * r)
                    {
                        ...
                        if (tile)
                        {
                            ...
                            if (elevationN == 0 && elevationE == 0 && elevationS == 0 &&
                                ...
                                elevationNWNW == 0 && elevationNENE == 0 && elevationSESE == 0 &&
                                elevationSWSW == 0)
                            {
        ...
        this->GenerateSingleLake(xCenter - maxRadius, yCenter - maxRadius, xCenter + maxRadius,
                                 yCenter + maxRadius, recursion - 1);
    }
}