...
namespace Forradia
{
    ...
    {
        // Computes the point in world space the camera should look at. This targets the center of
        // the player's current tile and uses the tile's elevation to set Z.
