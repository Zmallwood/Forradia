...
namespace Forradia
{
    ...
    {
        // Create an intermediary surface with RGBA format
        ...
        // Copy the source surface data to the intermediary
        // surface.

        SDL_BlitSurface(surface.get(), 0,
                        intermediary.get(), 0);

        // Upload the surface pixel data to the OpenGL
        // texture.
        ...
        // Set the texture minification filter to linear
        // interpolation.

        glTexParameteri(GL_TEXTURE_2D,
                        GL_TEXTURE_MIN_FILTER, GL_LINEAR);

        // Set the texture magnification filter to linear
        // interpolation.
