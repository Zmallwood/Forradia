...
namespace YrradiaSDL2.YrradiaTheme.Scenes.WorldGenerationScene.Modules
{
    public class WorldGenerator
    {
        ...
        private void GenerateMobs()
        {
            ...
            var mobIndex = Random.Shared.Next(_.mobProperties.m_properties.Count);
            var mobType = _.mobProperties.m_properties.ElementAt(mobIndex).Key;
