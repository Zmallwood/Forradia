            ...
            for (var y = 0; y < gridSize.Height; y++)
            {
                for (var x = 0; x < gridSize.Width; x++)
                {
                    ...
                    if (tile.m_mob != null)
                    {
                        ...
                        _.textRenderer.DrawString(_.mobProperties.GetMobName(mobType) + " Lvl " + _.mobProperties.GetMobLevel(mobType), new(area.X + area.Width/2, area.Y), Colors.wheat, FontSizes._20, true);
                    }
                    ...
                    _.imageRenderer.DrawImage("Filter", area.X, area.Y, area.Width, area.Height);
