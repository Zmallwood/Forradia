...
namespace Forradia::Theme0::GameplayCore
{
    ...
    bool TileHovering::CheckIfRayIntersectsTile(int xCoordinate, int yCoordinate) const
    {
        ...
        // Convert normalized mouse coordinates to clip space (normalized coordinates are in range
        // [-1, 1]).
        ...
        // Test intersection with two triangles that make up the quad Triangle 1: NW -> NE -> SE.
