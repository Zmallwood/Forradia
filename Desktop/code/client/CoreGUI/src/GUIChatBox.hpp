...
class GUIChatBox : public GUIPanel {
 ...
 private:
  ...
  inline static const float k_lineHeight{0.028f};      ///< The height of each line in the chat box.
  inline static const float k_separatorHeight{0.003f}; ///< The height of the separator between
