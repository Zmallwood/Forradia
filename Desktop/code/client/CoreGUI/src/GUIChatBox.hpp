        ...
        class GUIChatBox : public GUIPanel
        {
          ...
          private:
            ...
            const int k_renderIDSeparator{
                Hash("RenderIDSeparator")}; ///< Render ID of the separator.

            const int k_renderIDInputCursor{
                Hash("RenderIDInputCursor")}; ///< Render ID of the input
            ///< cursor.

            const int k_renderIDInputText{
                Hash("RenderIDInputText")}; ///< Render ID of the input text.
