...
namespace Forradia {
    auto GUIMeter::RenderDerived() const -> void {
        ...
        _<Color2DRenderer>().DrawFilledRectangle(
            k_renderIDBackground, Palette::GetColor<Hash("DarkGray")>(), GetBounds().x,
        ...
        _<Color2DRenderer>().DrawLine(k_renderIDLineTop,
                                      ...
                                      bounds.y, bounds.x + bounds.width, bounds.y, 0.002f);
        ...
        _<Color2DRenderer>().DrawLine(k_renderIDLineRight,
                                      ...
                                      bounds.y + bounds.height, 0.002f);

        _<Color2DRenderer>().DrawLine(k_renderIDLineLeft,
                                      Palette::GetColor<Hash("WheatTransparent")>(), bounds.x,
                                      bounds.y, bounds.x, bounds.y + bounds.height, 0.002f);
    }
}
