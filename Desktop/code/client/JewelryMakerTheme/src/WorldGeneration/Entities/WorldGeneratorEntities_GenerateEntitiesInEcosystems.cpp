...
namespace ForradiaEngine::JewelryMakerTheme
{
    ...
    auto isNearWater(const std::shared_ptr<WorldArea> &worldArea, int xPos, int yPos, int radius)
        -> bool
    {
    ...
    auto calculateNearbyTreesCount(const std::shared_ptr<WorldArea> &worldArea, int xPos, int yPos)
        -> int
    {
    ...
    auto generateScatteredRedBirds(const std::shared_ptr<WorldArea> &worldArea, int worldScaling)
        -> void
    {
        auto worldAreaSize{worldArea->getSize()};
