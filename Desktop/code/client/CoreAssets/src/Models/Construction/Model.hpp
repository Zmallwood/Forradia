    ...
    namespace Forradia
    {
        ...
        class Model
        {
          ...
          private:
            ...
            /// @param transform The resulting transformation of the node, with regards to its
            /// parent nodes.
            ///
            ...
            /// @param transformation The resulting transformation that should be applied to the
            /// mesh, with regards to its parent nodes.
            /// @return The processed mesh as a GLMMesh (non-assimp type) object.
            ///
            GLMMesh ProcessMesh(aiMesh *mesh, const aiScene *scene,
            ...
            /// @param transformation The transformation that should be applied to the vertices of
            /// the mesh.
