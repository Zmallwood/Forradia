    ...
    namespace Forradia::Theme0
    {
        void GUIPlayerBodyWindow::Initialize()
        {
            ...
            auto overallBodyImageButton{std::make_shared<GUIButton>(
                ...
                {
                    this->SelectBodyPart(
                        CInt(Theme0::GameplayCore::PlayerBodyPartTypes::OverallBody));
            ...
            auto rightArmBodyImageButton{std::make_shared<GUIButton>(
                "GUIButtonRightArm", 0.1f - imageWidth / 2 - imageWidth, 0.04f, imageWidth,
                imageHeight, "",
                [this]
                {
            ...
            auto leftArmBodyImageButton{std::make_shared<GUIButton>(
                "GUIButtonLeftArm", 0.1f - imageWidth / 2 + imageWidth, 0.04f, imageWidth,
                imageHeight, "",
                [this]
                {
            ...
            auto legsImageButton{std::make_shared<GUIButton>(
                "GUIButtonLegs", 0.1f - imageWidth / 2, 0.04f + imageHeight, imageWidth,
                imageHeight, "",
                [this]
                {
            ...
            m_labelBodyPartStrength =
                std::make_shared<GUILabel>("GUILabelBodyPartStrength", 0.01f + 0.01f,
        ...
        void GUIPlayerBodyWindow::UpdateBodyPartInfoLabels()
        {
            ...
            case overallBody:
            {
                ...
                auto strength{
                    playerBody
                        .GetBodyPartPtr(Theme0::GameplayCore::PlayerBodyPartTypes::OverallBody)
                        ->GetStrength()};
