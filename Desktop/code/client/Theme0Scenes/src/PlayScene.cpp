...
auto PlayScene::InitializeDerived() -> void {
  ...
  auto btnLoadGame{std::make_shared<GUIButton>("PlaySceneButtonLoadGame", 0.45f, 0.44f, 0.1f, 0.04f,
                                               "Load game", [] {})};
  GetGUI()->AddChildComponent(btnLoadGame);

  auto btnBack{std::make_shared<GUIButton>("PlaySceneButtonBack", 0.45f, 0.56f, 0.1f, 0.04f, "Back",
