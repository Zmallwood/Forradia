...
namespace Forradia
{
    void TileHovering::Update()
    {
        ...
        auto hoveredXCoordinate{playerPosition.x - (gridSize.width - 1) / 2 + screenRelativeX};

        auto screenRelativeXPx{(hoveredXCoordinate - (playerPosition.x - (gridSize.width - 1) / 2)) * tileSize.width};
