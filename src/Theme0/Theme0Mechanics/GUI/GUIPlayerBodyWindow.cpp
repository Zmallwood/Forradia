...
namespace Forradia
{
    void GUIPlayerBodyWindow::Initialize()
    {
        ...
        auto overallBodyImageButton{std::make_shared<GUIButton>(0.1f - imageWidth / 2, 0.04f, imageWidth, imageHeight, "", [this]
                                                                { SelectBodyPart(BodyPartTypes::OverallBody);
                                                                    UpdateBodyPartInformationLabels(); }, "GUIImageOverallBody", "GUIImageOverallBodyHovered")};

        AddChildComponent(overallBodyImageButton);

        auto rightArmBodyImageButton{std::make_shared<GUIButton>(0.1f - imageWidth / 2 - imageWidth, 0.04f, imageWidth, imageHeight, "", [this]
                                                                 { SelectBodyPart(BodyPartTypes::RightArm);
                                                                UpdateBodyPartInformationLabels(); }, "GUIImageRightArm", "GUIImageRightArmHovered")};

        AddChildComponent(rightArmBodyImageButton);

        auto leftArmBodyImageButton{std::make_shared<GUIButton>(0.1f - imageWidth / 2 + imageWidth, 0.04f, imageWidth, imageHeight, "", [this]
                                                                { SelectBodyPart(BodyPartTypes::LeftArm);
                                                                UpdateBodyPartInformationLabels(); }, "GUIImageLeftArm", "GUIImageLeftArmHovered")};

        AddChildComponent(leftArmBodyImageButton);

        auto legsImageButton{std::make_shared<GUIButton>(0.1f - imageWidth / 2, 0.04f + imageHeight, imageWidth, imageHeight, "", [this]
                                                         { SelectBodyPart(BodyPartTypes::Legs); 
                                                        UpdateBodyPartInformationLabels(); }, "GUIImageLegs", "GUIImageLegsHovered")};
