...
namespace forr {
  void add_main_scene_gui_components(std::shared_ptr<gui> main_scene_gui) {
    ...
    main_scene_gui->add_child_component(__<gui_text_console>());
    ...
    main_scene_gui->add_child_component(__<gui_system_menu>());
    main_scene_gui->add_child_component(__<gui_inventory_window>());
    main_scene_gui->add_child_component(__<gui_player_body_window>());
