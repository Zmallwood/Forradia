      ...
      for (auto j = 0; j < len; j++) {
        ...
        if (tl && prev_tl) {
          ...
          if (x_coord == prev_x_coord && y_coord > prev_y_coord) {
            prev_tl->set_river_direction_1(directions::south);
            tl->set_river_direction_2(directions::north);
          } else if (x_coord == prev_x_coord && y_coord < prev_y_coord) {
            prev_tl->set_river_direction_1(directions::north);
            tl->set_river_direction_2(directions::south);
          } else if (y_coord == prev_y_coord && x_coord > prev_x_coord) {
            prev_tl->set_river_direction_1(directions::east);
            tl->set_river_direction_2(directions::west);
          } else if (y_coord == prev_y_coord && x_coord < prev_x_coord) {
            prev_tl->set_river_direction_1(directions::west);
            tl->set_river_direction_2(directions::east);
          } else if (y_coord < prev_y_coord && x_coord > prev_x_coord) {
            prev_tl->set_river_direction_1(directions::north_east);
            tl->set_river_direction_2(directions::south_west);
          } else if (y_coord > prev_y_coord && x_coord > prev_x_coord) {
            prev_tl->set_river_direction_1(directions::south_east);
            tl->set_river_direction_2(directions::north_west);
          } else if (y_coord < prev_y_coord && x_coord < prev_x_coord) {
            prev_tl->set_river_direction_1(directions::north_west);
            tl->set_river_direction_2(directions::south_east);
          } else if (y_coord > prev_y_coord && x_coord < prev_x_coord) {
            prev_tl->set_river_direction_1(directions::south_west);
            tl->set_river_direction_2(directions::north_east);
          }
        }
